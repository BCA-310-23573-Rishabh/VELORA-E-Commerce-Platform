...
<body>
  ...
  <header class="header"><div class="container header-content"><div class="header-left"><a href="index.php" class="logo">VELORA</a></div><div class="header-center"><div class="search-bar"><input type="text" placeholder="Search for products..." class="search-input" id="searchInput"><button class="search-btn" aria-label="Search">🔍</button></div></div><div class="header-right"><a href="login.php" class="header-icon" title="Account"><span class="icon">👤</span></a><a href="cart.php" class="header-icon" title="Shopping Cart"><span class="icon">🛍️</span><span class="cart-count" id="cartCount">0</span></a></div></div><nav class="navbar"><div class="container"><div class="nav-menu"><a href="index.php" class="nav-item">Home</a><a href="shop.php" class="nav-item">Shop All</a><a href="shirts.php" class="nav-item">Shirts</a><a href="tshirts.php" class="nav-item">T-shirts</a><a href="jeans.php" class="nav-item">Jeans</a><a href="trousers.php" class="nav-item">Trousers</a><a href="cargo-pants.php" class="nav-item active">Cargo Pants</a><a href="shoes.php" class="nav-item">Shoes</a><a href="overshirt.php" class="nav-item">Overshirt</a><a href="plus-size.php" class="nav-item">Plus-Size</a><a href="shorts.php" class="nav-item">Shorts</a></div></div></nav></header>
  <main class="shop-main container"><section class="shop-hero"><h1>Cargo Pants</h1><p>Utility-inspired cargo pants made for comfort and movement.</p></section><div class="shop-layout"><aside class="filter-sidebar" id="filterSidebar"><h3>Filter</h3><div class="filter-group"><h4>Categories</h4><label><input type="checkbox" class="filter-checkbox" value="cargo-pants" checked> Cargo Pants</label></div></aside><section class="shop-content"><div class="shop-toolbar"><div class="product-count" id="productCount">0 products</div><select id="sortSelect"><option value="featured">Featured</option><option value="low-high">Price: Low to High</option><option value="high-low">Price: High to Low</option></select></div><div class="shop-products-grid" id="shopProductsGrid"></div><button class="load-more-btn" id="loadMoreBtn" style="display:none;">Load More</button></section></div></main>
